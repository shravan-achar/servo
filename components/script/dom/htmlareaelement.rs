    ...
    pub fn parse(coord: &str, target: Shape) -> Option<Area> {
        ...
        while index < size {
            ...
            while index < size {
                ...
                match val {
                    0x30...0x39 | 0x2E | 0x2D | 0x45 | 0x65 => array.push(val),
                    _ => break,
                }
...
impl HTMLAreaElement {
    ...
    fn get_shape_from_coords(&self) -> Option<Area> {
       ...
       let shp: Shape;
       let shape = elem.get_string_attribute(&local_name!("shape"));
       ...
       match shape.as_ref() {
        ...
        if elem.has_attribute(&local_name!("coords")) {
            let attribute = elem.get_string_attribute(&local_name!("coords"));
