...
fn test_hit_test_circle() {
   let circle1 = Area::Circle { left: 20.0, top: 10.0, radius: 5.0 };
   assert!(!circle1.hit_test(Point2D::new(10.0, 20.0)));
   let circle2 = Area::Circle { left: 10.0, top: 10.0, radius: 5.0 };
   assert!(circle2.hit_test(Point2D::new(10.0, 12.0)));
}
